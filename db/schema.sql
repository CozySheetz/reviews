...
insert into reviews (id, accuracy, communication, cleanliness, locat, checkIn, val, overview, dateCreated, listingId, userId, bookingId) values (23, 3, 3, 2, 2, 5, 2, 'Duis consequat dui nec nisi volutpat eleifend.', '9/28/2018', 43, 23, 23);
insert into reviews (id, accuracy, communication, cleanliness, locat, checkIn, val, overview, dateCreated, listingId, userId, bookingId) values (24, 2, 3, 3, 2, 2, 2, 'Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', '8/4/2018', 16, 24, 24);
insert into reviews (id, accuracy, communication, cleanliness, locat, checkIn, val, overview, dateCreated, listingId, userId, bookingId) values (25, 2, 5, 3, 4, 1, 4, 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.', '6/20/2018', 98, 25, 25);
